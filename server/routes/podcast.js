...
import { addView, addepisodes, createPodcast, favoritPodcast, getByCategory, getByTag, getPodcastById, getPodcasts, random, search, mostpopular, deletePostCard } from "../controllers/podcasts.js";
...
router.delete("/delete-postcard/:id",deletePostCard); 
