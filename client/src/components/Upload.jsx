...
const Upload = ({ setUploadOpen }) => {
    ...
    const createpodcast = async () => {
        ...
        let postCastInfo = podcast; 
        postCastInfo.thumbnail = newLink
        await createPodcast(postCastInfo, token).then((res) => {
            setDisabled(true);
                            ...
                            <OutlinedBox style={{ marginTop: "12px" }}>
                                ...
                                {imageUpload && (
                                    <div>
                                        ...
                                        <img src={imageUpload} alt="Selected" style={{ width: '200px', height: '200px' }} />
                                    </div>
                                )}
                            </OutlinedBox>
                            <OutlinedBox style={{ marginTop: "12px" }}>
